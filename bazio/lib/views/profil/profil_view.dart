...
class ProfileView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    //email lu depuis Firestore pour rester stable meme si Firebase emet temporairement null
    ...
    final salesCount = uid.isNotEmpty
        ? ref.watch(mySalesCountProvider(uid))
        : 0;
    final favoritesAsync = ref.watch(favoritesProvider);
    final favoritesCount = favoritesAsync.isLoading
        ? null
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Column(
                  children: [
                    ...
                    createdAtAsync.when(
                      ...
                      data: (date) => Text(
                        date != null
                            ? 'Membre depuis ${_formatDate(date)}'
                            : '',
                        textAlign: TextAlign.center,
                        style: AppTextStyles.body.copyWith(
              ...
              //menu de navigation avec badge de comptage sur chaque section
              _ProfileTile(
              ...
              _ProfileTile(
                icon: Icons.history,
                label: 'MES VENTES',
                badgeCount: salesCount > 0 ? salesCount : null,
                onTap: () => context.push('/my-sales'),
              ),
              const SizedBox(height: 12),
              ...
              _ProfileTile(
                ...
                label: 'MES FAVORIS',
                badgeCount: (favoritesCount != null && favoritesCount > 0)
                    ? favoritesCount
                    : null,
              ...
              ratingAsync.when(
                ...
                data: (info) => _ProfileTile(
                  icon: Icons.star_outline_rounded,
                  label: 'MES AVIS',
                  badgeCount: info.reviewCount > 0 ? info.reviewCount : null,
                  onTap: () => context.push('/my-reviews'),
                ),
              ),
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(icon, color: AppColors.blackOp, size: 22),
              ),
